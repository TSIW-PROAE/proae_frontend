            ...
            <div className="processos-seletivos-section">
              <div className="processos-seletivos-header">
                ...
                <div className="filter-buttons">
                  <button
                    className={`filter-button ${currentFilter === "todos" ? "active" : ""}`}
                    onClick={() => handleFilterChange("todos")}
                  >
                    Todos
                  </button>
                  <button
                    className={`filter-button ${currentFilter === "inscricoes" ? "active" : ""}`}
                    onClick={() => handleFilterChange("inscricoes")}
                  >
                    Inscrições abertas
                  </button>
                  <button
                    className={`filter-button ${currentFilter === "concluidos" ? "active" : ""}`}
                    onClick={() => handleFilterChange("concluidos")}
                  >
                    Concluídos
                  </button>
                  <button
                    className={`filter-button ${currentFilter === "editais" ? "active" : ""}`}
                    onClick={() => handleFilterChange("editais")}
                  >
                    Editais abertos
                  </button>
                </div>
