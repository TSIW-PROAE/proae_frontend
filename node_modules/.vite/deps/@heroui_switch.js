...
function useSwitch(originalProps = {}) {
  ...
  const ariaSwitchProps = (0, import_react37.useMemo)(() => {
  ...
  const getWrapperProps = (0, import_react36.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
        "aria-hidden": true,
  ...
  const getThumbProps = (0, import_react36.useCallback)(
    (props2 = {}) => ({
      ...props2,
  ...
  const getLabelProps = (0, import_react36.useCallback)(
    (props2 = {}) => ({
      ...props2,
      id: labelId,
  ...
  const getThumbIconProps = (0, import_react36.useCallback)(
    (props2 = {
  ...
  const getStartContentProps = (0, import_react36.useCallback)(
    (props2 = {}) => ({
      width: "1em",
      height: "1em",
      ...props2,
  ...
  const getEndContentProps = (0, import_react36.useCallback)(
    (props2 = {}) => ({
      width: "1em",
      height: "1em",
      ...props2,
...
var Switch = forwardRef((props, ref) => {
  ...
  const clonedThumbIcon = typeof thumbIcon === "function" ? thumbIcon(getThumbIconProps({ includeStateProps: true })) : thumbIcon && (0, import_react38.cloneElement)(thumbIcon, getThumbIconProps());
  const clonedStartContent = startContent && (0, import_react38.cloneElement)(startContent, getStartContentProps());
  const clonedEndContent = endContent && (0, import_react38.cloneElement)(endContent, getEndContentProps());
